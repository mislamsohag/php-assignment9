<h1 style="color:blue; text-align:center">Project of Experience</h1>
<section class="d-flex row">
    <div class="col-lg-4 col-md-6 col-sm-12 py-3">
        <div class="field-border text-center projectBox">
            <h2>HTML & CSS</h2>
            <h3>Mid Label Learner</h3>
            <hr>
            <p class="text-justify">I have built several websites with HTML & CSS including 1 site currently live <a href="{{url('www.pestcemeterybd.com')}}">www.pestcemeterybd.com</a>. Moreover, I am constantly learning new things and implementing them with work. Insha-Allah I will bring a new sun.</p>
            <div class="pt-2 link-button">
                <a href="{{url('https://www.pestcemeterybd.com')}}">Go to Live site</a>
            </div>
